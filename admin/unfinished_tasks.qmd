...
3. tex fiules to format pdf (see quarto yaml)
4. it is re-rendering all files every push. Why isnt it using the freeze folder to only rerender the ones that changed? see [here](https://github.com/quarto-dev/quarto-cli/issues/3628)
