...
![Senesced _Lepidium_ leaves. Leaves like this are probably best excluded from damage estimates.](images/img9.png){#fig-lepidium fig-align="center" width=80%}
...
![Nose pointing method to acquire a random sample of plant parts. (A) The researcher establishes a fixed point in his field of vision with an “L”-shaped hand position while turned away from the plant. (B) They then turn to the plant, open a single eye, and chooses the leaf that they are pointing to.](images/img10_2.png){#fig-nose}{width=90%}
...
![Skunkbush sumac (_Rhus trilobata_)](images/img12.png){#fig-random width=70%}
...
![Locust (_Robinia_)](images/img13.png){#fig-arbitrary width=70%}
...
![Leaf with both 'interior' and 'leaf-margin' damage.](images/img14.png){#fig-location}
