...
![Senesced _Lepidium_ leaves. Leaves like this are probably best excluded from damage estimates.](images/img9.png){#fig-lepidium fig-align="center" fig-scap="Senesced _Lepidium_ leaves." width=80%}
...
![Nose pointing method to acquire a random sample of plant parts. (A) The researcher establishes a fixed point in his field of vision with an “L”-shaped hand position while turned away from the plant. (B) They then turn to the plant, open a single eye, and chooses the leaf that they are pointing to.](images/img10_2.png){#fig-nose width=95%}
...
![Leaf with both 'interior' and 'leaf-margin' damage.](images/img14.png){#fig-location width=70%}
...
![Internal feeding insects](images/img15.png){#fig-internal width=70%}
