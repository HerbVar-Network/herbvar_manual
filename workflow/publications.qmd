...
The [`new_dataset_template`](https://github.com/HerbVar-Network/new_dataset_template) on Github can also be used to write the manuscript in markdown using [`papaja`](https://github.com/crsh/papaja) or one of the [`rticles`](https://github.com/rstudio/rticles) templates. 
