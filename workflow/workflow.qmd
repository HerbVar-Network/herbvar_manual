...
2. Collect Data.
3. Create a repository for cleaning and analyzing the data using HerbVar's [`new_dataset_template`](https://github.com/HerbVar-Network/new_dataset_template) (see @sec-data-analysis).
