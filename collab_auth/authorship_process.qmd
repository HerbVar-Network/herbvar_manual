...
---
title: HerbVar Authorship Process 
...
## Encouraging Inclusive Authorship for Working Group Papers
...
### Identifying potential co-authors
...
### Approaches for inviting co-authors
...
1. The lead author identifies site PIs who have contributed data to be used in this project using the HerbVar co-author database. 
...
3. Individuals wishing to opt-in respond to the lead author.

4. The lead author is then responsible for organizing all co-authors to complete the paper.
...
## Authoring a working group paper
...
4. Prepare a manuscript proposal, and email it to one of the HerbVar Steering Committee members (https://herbvar.org/leadership.html). Your proposal should list the lead author(s) and any other known authors, plans for recruiting additional authors if any, the title and abstract, and the specific types of data that you wish to use. You can also specify more detail about response and predictor variables (if appropriate), and indicate a timeline for analysis and writing. Proposed ideas are reviewed by the Steering Committee to ensure there is sufficient distinction from proposed and ongoing HerbVar papers. The Steering Committee may suggest altering or combining analyses and papers to resolve issues of overlap.

5. After receiving Steering Committee Feedback, your proposal will be posted on the HerbVar website.
...
## Authorship Disputes
The steering committee works to ensure communication across projects to avoid overlap of manuscripts, and provides guidance on procedures and guidelines. Disputes over authorship and manuscripts should be brought to the Steering Committee for resolution.

Current Steering Committee: Will Wetzel (Montana State University, wcwetzel@msu.edu), Phil Hahn (University of Florida, hahnp@ufl.edu), Susan Whitehead (Virginia Tech, swhitehead@vt.edu), Nora Underwood (Florida State University, nunderwood@bio.fsu.edu), Brian Inouye (Florida State University, binouye@bio.fsu.edu), Emilio Bruna (University of Florida, embruna@uf.edu), Ivalu Cacho (Universidad Nacional Autonoma de Mexico, ivalu.cacho@gmail.com), Karen Abbott (Case Western Reserve University, kca27@case.edu)

## Author Lists, Acknowledgements, and Keywords
...
Please use this text in the acknowledgments of HerbVar manuscripts:
"This work was generated using data from the HerbVar Network (https://herbvar.org/) funded at the site-scale by individual researchers. Coordination and data management have been supported by funding to Will Wetzel and co-PIs from the National Science Foundation Research Coordination Network program (NSF-DEB-2203582)"

Please use the following as one of your keywords on submitted manuscripts, so that HerbVar work is easily indexed and searchable:
"HerbVar"
