...
2.  **Propose a new Working Group**. Working Groups analyze and publish existing data, design and coordinate new add-on data collection efforts, and develop educational resources with HerbVar data (see @sec-new_analyses). You can also **join an existing Working Group** open to new members. <!-- once we post the abstracts of existing projects, we should link to them here -->

3.  **Propose a new add-on data collection effort** to have HerbVar members and Site PIs collect data you would like to analyze and publish (see @sec-new_data_collection).
