...
2.  Join an **existing Working Group** open to new members. Working Groups analyze and publish existing data, design and coordinate new add-on data collection efforts, and develop educational resources.

3.  Propose a **new Working Group** for a project analyzing existing HerbVar data or developing education resources.
