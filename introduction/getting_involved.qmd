...
2.  **Propose a new Working Group**. Working Groups analyze and publish existing data, design and coordinate new add-on data collection efforts, and develop educational resources with HerbVar data (see @sec-new_analyses). You can also **join en existing Working Group** open to new members. 
