...
Our network is excited about researchers using HerbVar data for new analyses and publications. People interested in analyzing HerbVar data for publication should read @sec-authorship_process for a detailed outline of how to propose a project.
