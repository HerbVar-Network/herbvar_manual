---
title: "Data-Sharing and Usage Agreement"
...
1. The data sharer releases ownership of the data that they contribute to the HerbVar Network and allows the Network to use the data with appropriate credit given to the data sharer for scientific purposes (e.g., manuscripts, grant applications, etc.). Network members are credited as here and specific co-authorship guidelines for manuscripts produced from Network data are defined here.

2. The data sharer will not publish any findings or conclusions derived from analysis of shared Network data without a written collaboration agreement from the HerbVar Steering Committee (members here). Members are, however, entitled to publish their own personal datasets that they contribute.
